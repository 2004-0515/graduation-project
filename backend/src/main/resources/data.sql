...
-- 手机数码（较早上架）
('iPhone 15 Pro Max', 'Apple iPhone 15 Pro Max 256GB 原色钛金属，A17 Pro芯片，钛金属设计', 1, 9999.00, 10999.00, 500, 1234, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-01 10:00:00'),
('华为 Mate 60 Pro', '华为Mate60 Pro 12GB+512GB 雅丹黑，麒麟9000S芯片，卫星通话', 1, 6999.00, 7999.00, 300, 2345, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-02 14:30:00'),
('小米14 Ultra', '小米14 Ultra 16GB+512GB 黑色，骁龙8 Gen3，徕卡光学镜头', 1, 5999.00, 6499.00, 400, 3456, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-05 09:15:00'),
('MacBook Pro 14', 'Apple MacBook Pro 14英寸 M3 Pro芯片 18GB+512GB 深空黑', 1, 14999.00, 16999.00, 200, 876, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-08 16:00:00'),
('iPad Pro 12.9', 'Apple iPad Pro 12.9英寸 M2芯片 256GB WiFi版 深空灰', 1, 8499.00, 9499.00, 350, 654, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-10 11:30:00'),

-- 家用电器（中期上架）
('海尔冰箱 BCD-470', '海尔470升十字对开门冰箱 一级能效 风冷无霜', 2, 4599.00, 5299.00, 150, 432, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-12 08:00:00'),
('美的空调 KFR-35GW', '美的1.5匹变频冷暖空调 一级能效 智能WiFi控制', 2, 2999.00, 3499.00, 280, 765, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-14 13:45:00'),
('西门子洗衣机 WM12', '西门子10公斤滚筒洗衣机 变频电机 智能投放', 2, 3899.00, 4599.00, 180, 543, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-16 10:20:00'),
('戴森吸尘器 V15', '戴森V15 Detect无绳吸尘器 激光探测 智能显示', 2, 4990.00, 5490.00, 120, 321, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-18 15:00:00'),

-- 服装鞋帽（较新上架）
('Nike Air Max 270', 'Nike Air Max 270 男子运动鞋 气垫缓震 透气舒适', 3, 899.00, 1199.00, 500, 2134, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-20 09:00:00'),
('Adidas Ultraboost', 'Adidas Ultraboost 22 跑步鞋 Boost中底 轻量回弹', 3, 1099.00, 1499.00, 400, 1876, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-21 14:30:00'),
('优衣库羽绒服', '优衣库高级轻型羽绒服 90%白鸭绒 轻薄保暖', 3, 499.00, 699.00, 600, 3245, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-22 11:00:00'),

-- 美妆护肤（新品）
('SK-II神仙水', 'SK-II护肤精华露 230ml 改善肤质 细腻毛孔', 4, 1590.00, 1790.00, 200, 987, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-24 10:00:00'),
('兰蔻小黑瓶', '兰蔻小黑瓶精华肌底液 100ml 修护肌肤 提亮肤色', 4, 1280.00, 1480.00, 250, 1234, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-25 09:30:00'),
('雅诗兰黛眼霜', '雅诗兰黛小棕瓶眼霜 15ml 淡化细纹 紧致眼周', 4, 590.00, 690.00, 300, 876, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-26 14:00:00'),

-- 食品饮料（热销+新品）
('三只松鼠坚果礼盒', '三只松鼠坚果大礼包 1428g 8袋装 年货礼盒', 5, 128.00, 168.00, 1000, 5432, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-27 08:00:00'),
('农夫山泉矿泉水', '农夫山泉天然矿泉水 550ml*24瓶 整箱装', 5, 39.90, 49.90, 2000, 8765, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-15 12:00:00'),
('星巴克咖啡豆', '星巴克派克市场烘焙咖啡豆 1.13kg 中度烘焙', 5, 198.00, 238.00, 500, 2134, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-28 10:00:00'),

-- 图书音像（最新上架）
('三体全集', '刘慈欣《三体》全集 典藏版 科幻小说', 6, 99.00, 128.00, 800, 4321, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-28 16:00:00'),
('人类简史', '尤瓦尔·赫拉利《人类简史》从动物到上帝', 6, 68.00, 88.00, 600, 3456, 1, '/seed/product-card.svg', '["/seed/product-card.svg","/seed/product-card.svg"]', '2025-12-29 09:00:00');
