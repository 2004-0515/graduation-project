...
紫苑风鸢是一个功能完善的B2C电子商务平台，采用前后端分离架构，前端使用Vue 3 + TypeScript开发，后端使用Spring Boot构建RESTful API，数据库使用MySQL存储数据。系统实现了用户购物、订单管理、优惠券、商品评价等完整的电商业务功能，同时提供管理员后台进行商品、订单、用户等数据的管理。
