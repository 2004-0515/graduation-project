      ...
      <div class="settings-main">
        ...
        <el-card v-if="activeTab === 'security'" class="settings-card">
          ...
          <div class="security-info-section">
            ...
            >
              <template #default>
                <p>为了您的账号安全，建议定期修改密码。</p>
                <p>密码修改功能在"密码修改"标签页中。</p>
              </template>
            </el-alert>
            
            <div class="security-items" style="margin-top: 20px">
              <div class="security-item">
                <div class="security-info">
                  <div class="security-title">邮箱验证</div>
                  <div class="security-desc">已验证邮箱：{{ userInfo?.email || '未设置' }}</div>
                </div>
              ...
              <div class="security-item">
                ...
                <div class="security-action">
                  <el-tag v-if="userInfo?.phone" type="success" size="large">已绑定</el-tag>
                  <el-tag v-else type="warning" size="large">未绑定</el-tag>
                </div>
              </div>
            </div>
          </div>
